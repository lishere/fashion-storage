...
class Product_variant(models.Model):
    ...
    color_1_en                      = models.CharField(max_length=50, blank=False, verbose_name='Main color in Englisch')
    ...
    color_2_en                      = models.CharField(max_length=50, blank=True, verbose_name='2nd color in Englisch')
    ...
    color_3_en                      = models.CharField(max_length=50, blank=True, verbose_name='3rd color in Englisch')
    ...
    color_4_en                      = models.CharField(max_length=50, blank=True, verbose_name='4th color in Englisch')
    ...
    fabric_1_en                     = models.CharField(max_length=50, blank=False, verbose_name='Main fabric in Enlish')
    ...
    fabric_2_en                     = models.CharField(max_length=50, blank=True, verbose_name='2nd fabric in Englisch')
    ...
    fabric_3_en                     = models.CharField(max_length=50, blank=True, verbose_name='3nd fabric in Englisch')
    ...
    fabric_4_en                     = models.CharField(max_length=50, blank=True, verbose_name='4nd fabric in Englisch')
