# -*- coding: utf-8 -*-
# Generated by Django 1.10.4 on 2017-01-07 10:05
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('api', '0009_store_shipping_address'),
    ]
    ...
    operations = [
        ...
        migrations.AlterModelOptions(
            name='customer',
            options={'ordering': ('given_name', 'surname'), 'verbose_name': 'Customer', 'verbose_name_plural': 'Customers'},
        ),
        migrations.AlterModelOptions(
            name='invoice_address',
            options={'ordering': ('recipient',), 'verbose_name': 'Invoice address', 'verbose_name_plural': 'Invoice addresses'},
        ),
        migrations.AlterModelOptions(
            name='note',
            options={'ordering': ('-created',), 'verbose_name': 'Internal note', 'verbose_name_plural': 'Internal notes'},
        ),
        migrations.AlterModelOptions(
            name='person',
            options={'ordering': ('given_name', 'surname'), 'verbose_name': 'Person', 'verbose_name_plural': 'Persons'},
        ),
        migrations.AlterModelOptions(
            name='shipping_address',
            options={'ordering': ('recipient',), 'verbose_name': 'Shipping address', 'verbose_name_plural': 'Shipping addresses'},
        ),
        migrations.AlterModelOptions(
            name='store',
